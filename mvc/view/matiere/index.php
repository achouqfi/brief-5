...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                ...
                <li class="active"><a href="http://localhost/mvc/matiere"><i class="fa fa-fw fa-star"></i>  Matiere</a></li>
            </ul>
        </div>
    </nav>
    ...
    <div class="container">
        <div class="table-responsive">
            <div class="table-wrapper" >
                ...
                <form action="http://localhost/mvc/matiere/create"  method="post">
                    <div class="buttons">
                        <button class="btn btn-lg btn-info" data-toggle="dropdown" class="btnInsert"   type="button" class="button" value="Add" onclick="addItem()" >Add</button>
                    ...
                    <form action="http://localhost/mvc/matiere/update" method="POST">
                            <tr>
                                <td><label  for=""><?php echo $res['id'] ?></label><input type="hidden" value="<?php echo $res['id'] ?>" name="id" ></td>

                                <td>
                                    <label id="MtrLibellelabel<?=$i?>" for=""><?php echo $res['libelle_M'] ?></label>
                                    <input type="text" id="MtrLibelle<?=$i?>" value="<?php echo $res['libelle_M'] ?>" name="MatiereLibelle" style="display:none" >
                                </td>
                                ...
                                <td class="action" >
                                    ...
                                    <form action="http://localhost/mvc/matiere/delete" method="post">
    ...
    <script src="http://localhost/mvc/view/js/editMatiere.js" ></script>
